#!/usr/bin/env python3
"""Compatibility entry point for the engine-owned SOL v0.4 wadpack tool."""
...
tool = engine_root / "tools" / "sol-wadpack.py"

if not tool.is_file():
    raise SystemExit(f"SOL Engine v0.4 wadpack tool not found: {tool}")
